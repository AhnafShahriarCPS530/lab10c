  ...
  return (
    <div className="App">
      ...
      <header className="App-header">
        ...
        <p>Step6: Next I opened the folder, where I installed react, in Visual Studio Code; any text editor will work  </p>
        <p>Step7: Than I used the "cd" command to go to my react folder and executed the "npm start" command. This allowed me to edit my lab10c website using  react Webframe. </p>
